...
class DetectionNode(Node):
    def __init__(self):
        super().__init__('detection_node_openvino')
        self.bridge = CvBridge()
        
        self.declare_parameter('confidence_threshold', 0.8)
        self.declare_parameter('distance_threshold', 10.0)  # Distance in meters to consider detections as the same object
        ...
        self.model = YOLO(model_path, task='detect')  # OpenVINO model
